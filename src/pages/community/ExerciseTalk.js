...
function ExerciseTalk() {
    ...
    const getCommunitylist = (pageNumber) => {
        ...
        axios
            .get("http://localhost:3000/ExerciseTalklist", { params: params })
            .then(response => {
                            ...
                            <table border="1" align="center" style={{ width: '810px' }}>
                                ...
                                <thead>
                                    <tr style={{ textAlign: 'center' }}>
                                        ...
                                        <th style={{ border: '1px solid' }}>좋아요</th>
                                        <th style={{ border: '1px solid' }}>조회수</th>
                                    ...
                                    {communitylist.map(function (community, i) {
                                        ...
                                        return (
                                            <tr key={i} style={{ textAlign: 'center', border: '1px solid' }}>
                                                ...
                                                <td style={{ height: '60px' }}>{community.likecount}</td>
                                                <td style={{ height: '60px' }}>{community.readcount/2}</td>
